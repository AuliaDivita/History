...
import 'package:flutter_pemmob/model_main.dart';
import 'package:flutter_pemmob/page/detail_page.dart';

void main() {
  runApp(const SejarahPahlawan());
}


class SejarahPahlawan extends StatefulWidget {
  const SejarahPahlawan({Key? key});

  @override
  State<StatefulWidget> createState() {
    return _SejarahPahlawanState();
  }
}

class _SejarahPahlawanState extends State<SejarahPahlawan> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(
          child: Text('History',
              style: TextStyle(
                  color: root_bundle.Color.fromARGB(255, 92, 57, 112),
      ...
      floatingActionButton: AnimatedOpacity(
        ...
        child: FloatingActionButton(
          ...
          backgroundColor: root_bundle.Color.fromARGB(255, 92, 57, 112),
